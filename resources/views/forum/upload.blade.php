        ...
        <div class="upload">
                    ...
                    <div class="up-input mb-3">
                        <div class="form-file-group" style="width: 191px; height: 177px; border-radius: 50%">
                            <input type="file" style="display: none" id="up" name="up" onchange="preview(this)" />
                            <img class="poto-up" src="{{ asset('img/up.png') }}" onclick="document.querySelector('#up').click()" />
                        </div>
                        <div class="prev" id="previewBox" style="display: none">
                            <img src="" id="previewImg" style="width: 50%; text-align:center" onclick="document.querySelector('#up').click()" />
                        </div>
                    </div>
  ...
  <select name="Jenis Kanker">
    ...
    <option value="4">Kanker Usus Besar</option>
                    ...
                    <div class="form">
                            <!-- judul ya bund -->
                        <div class="pb-4">
                            <input id="judul" class="notname-input" type="text" placeholder="Judul" name="judul">
                        </div>

                        <!-- storynya bund -->
                        <div class="pb-4">
                            <textarea class="notname-input" rows="2" placeholder="Ceritakan Kisahmu" id="story"></textarea>
                        </div>
                    </div>
